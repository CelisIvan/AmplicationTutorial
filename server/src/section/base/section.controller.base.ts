  ...
  async create(
    ...
    if (invalidAttributes.length) {
      ...
      throw new errors.ForbiddenException(
        `providing the properties: ${properties} on ${"Section"} creation is forbidden for roles: ${roles}`
      );
    }
  ...
  async update(
    ...
    if (invalidAttributes.length) {
      ...
      const roles = userRoles
        ...
        .join(",");
      throw new errors.ForbiddenException(
        `providing the properties: ${properties} on ${"Section"} update is forbidden for roles: ${roles}`
      );
    }
    try {
